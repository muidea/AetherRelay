...
type ChatGPTRuntime interface {
	...
	StartChatGPTOAuth(context.Context, string, string) (accevents.OAuthStartResult, error)
...
type CodexRuntime interface {
	...
	StartCodexOAuth(context.Context, string, string, string) (codexevents.OAuthStartResult, error)
