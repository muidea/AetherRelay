...
func StreamHandler(source any, opts StreamHandlerOptions) http.Handler {
...
func writeStreamEvent(w http.ResponseWriter, flusher http.Flusher, reg metricsport.Reader) bool {
