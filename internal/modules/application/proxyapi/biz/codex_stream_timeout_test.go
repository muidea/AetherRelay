...
func TestCodexStreamTimeoutAndFeedback(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{name: "first", want: codexresponses.KindFirstEventTimeout, availabilityNeutral: true},
		{name: "headers", want: codexresponses.KindFirstEventTimeout, availabilityNeutral: true},
